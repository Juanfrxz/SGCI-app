...
{
    public class ImpDtoEmployeeRepository : IGenericRepository<DtoEmployee>, IDtoEmployeeRepository
    {
        private readonly ConexionSingleton _conexion;
        public ImpDtoEmployeeRepository(string connectionString)
        {
    ...
    ";
        ...
        public List<DtoEmployee> ObtenerTodos()
        {
            ...
            string query = "SELECT e.id AS id, t.nombre AS nombre FROM empleado e JOIN terceros t ON c.tercero_id = t.id;";
